...
/**
 * Created by zaba3 on 08.03.2016.
 */
public class TutorialFragment extends Fragment {
    ...
    public static TutorialFragment newInstance(CharSequence title, CharSequence description, int imageDrawable, int bgColor) {
        return newInstance(title, description, imageDrawable, bgColor, 0, 0);
    }


    public static TutorialFragment newInstance(CharSequence title, CharSequence description, int imageDrawable, int bgColor, int titleColor, int descColor) {
        TutorialFragment sampleSlide = new TutorialFragment();
